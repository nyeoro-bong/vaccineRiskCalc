...
function processV(){
  switch(uVac) {
    ...
    default:
      outputV =
      `国内感染死亡率は大規模摂取開始直後の4~6月平均1.74%。実施終盤の7~9月平均は0.04%でした。<br>ファイザー／モデルナ製ワクチンのCovid-19感染死亡抑制効果は明らかです。<br>感染致死率が平均を上回る60代以上の方へは早急なワクチン摂取が推奨されます。`
      break;
  }
  return outputV;
}
...
  riskCalcD();
  ...
  (参考)12月4日報道発表資料時点での全世代感染致死率:1.06% = (死者累計数:18,364 + 重症者数:28) / 陽性者累計数:1,727,701<br>
  `;
 ...
 <a href="https://www.mhlw.go.jp/stf/newpage_22520.html">  新型コロナウイルス感染症（変異株）の無症状病原体保有者について（空港検疫）| 厚生労働省</a><br>
