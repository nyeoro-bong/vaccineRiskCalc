...
function processV(){
  switch(uVac) {
    ...
    case "moderna":
      outputV = 
      `モデルナはmRNA型ワクチンで発症予防効果率は約94%です。<br>副反応が確認されておりファイザーに比べて痛みや発熱等症状の発生率が(5〜20pt)高めです。<br>まれに起こる重大な副反応として、ショックやアナフィラキシーがあります。<br>また、ごくまれではあるものの、ワクチン接種後に軽症の心筋炎や心膜炎が報告されています。<br>1回目よりも2回目の接種の後に多く、若い方、特に男性に多い傾向が見られます。<br>New! 10/15更新(厚労省 武田／モデルナ社の新型コロナワクチンについて より)`;
      break;
    case "astra-zeneca":
      outputV = 
...
  riskCalcD();
  ...
  (参考）10月23日報道発表資料時点での全世代感染致死率:1.07%　＝（死者数:18,183 + 重症:208）/ 陽性者数:1,716,393 <br>
  `;
 ...
 <a href="https://www.mhlw.go.jp/stf/newpage_21832.html">  新型コロナウイルス感染症の現在の状況と厚生労働省の対応について（令和３年10月23日版） | 厚生労働省</a><br>
